"""wayfinder-codex CLI entry point (Phase 7b)."""

from __future__ import annotations

import sys

from wayfinder.brains.codex import CodexBrain
...
def main(argv: list[str] | None = None) -> None:
    """Run the wayfinder CLI with a coding-agent brain."""
    try:
        ...
        try:
            ...
            llm_client = None
        brain = CodexBrain(llm_client=llm_client)
        run_cli(args, brain=brain, prog="wayfinder-codex")
    except SystemExit:
        raise
